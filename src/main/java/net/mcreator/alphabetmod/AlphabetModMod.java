 ...
 *
 */
package net.mcreator.alphabetmod;
...
@Mod("alphabet_mod")
public class AlphabetModMod {
	public static final Logger LOGGER = LogManager.getLogger(AlphabetModMod.class);
	public static final String MODID = "alphabet_mod";
	private static final String PROTOCOL_VERSION = "1";
	public static final SimpleChannel PACKET_HANDLER = NetworkRegistry.newSimpleChannel(new ResourceLocation(MODID, MODID), () -> PROTOCOL_VERSION, PROTOCOL_VERSION::equals, PROTOCOL_VERSION::equals);
	private static int messageID = 0;

	public AlphabetModMod() {
		AlphabetModModTabs.load();
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		AlphabetModModBlocks.REGISTRY.register(bus);
